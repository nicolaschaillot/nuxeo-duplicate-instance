...
/**
 * JAX-RS component used to do duplication of the whole database.
 *
 * @since 7.10
 */
@Path("duplicateInstance")
public class DuplicateInstanceRoot {

    public static Log log = LogFactory.getLog(DuplicateInstanceRoot.class);
